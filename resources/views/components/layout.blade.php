...
<head>
    ...
    <title>Veejay's Task Manager</title>
    <meta name="author" content="Veejay Guibone">
    ...
    <aside class="relative bg-blue-600 w-54 shadow-xl">
        <div class="p-6">
            <a href="{{ route('task.index') }}"
                class="text-white text-3xl font-semibold uppercase hover:text-gray-300">Veejay's Task Manager</a>
            <button
    ...
    <div class="w-full flex flex-col h-screen overflow-y-hidden">
        ...
        <div class="w-full overflow-x-hidden border-t flex flex-col">
            ...
            <footer class="w-full bg-white text-right p-4">
                Built by <a target="_blank" href="https://veejaytech.netlify.com/" class="underline">Veejay Guibone</a>.
            </footer>
        </div>
